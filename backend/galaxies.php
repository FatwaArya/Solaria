    ...
    <style>
        ...
        * {
        ...
        .milky-way:hover {
            ...
            box-shadow: 0 0 60px 20px #fff, /* inner white */ 0 0 60px 20px #f0f, /* middle magenta */ 0 0 140px 20px #0ff; /* outer cyan */
        }
...
<div class="header">
    <div class="navbar">
        <a href="./index(login).php">
            <box-icon name='left-arrow-alt' color='white' size='lg'></box-icon>
        </a>
        <h1>Solaria</h1>
    </div>
</div>
        ...
        <div class="galaxies">
            <div class="milky-way" id="milkyway">
                <a href="../planet.php">
                    ...
                    <p>The Milky Way is the galaxy that includes our Solar System, with the name describing the galaxy's
                        appearance from Earth: a hazy band of light seen in the night sky formed from stars that cannot
                        be individually distinguished by the naked eye.</p>
